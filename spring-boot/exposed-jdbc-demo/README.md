...
![Application Structure Flow 2](../../docs/images/readme-diagrams/spring-boot-exposed-jdbc-demo-diagram-02.png)
...
└── config/
    ...
    └── ExposedConfig.kt             # Exposed JDBC configuration (Spring Boot)
```
