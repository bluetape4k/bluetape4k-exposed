...
class BatchBuilderTest {
    ...
    @Test
    fun `BatchStepBuilder - 생성 시 control character 이름을 거부`() {
        assertFailsWith<IllegalArgumentException> {
            BatchStepBuilder<String, String>("step\nsecret")
        }
    }

    @Test
    fun `BatchJobBuilder - 생성 시 control character 이름을 거부`() {
        assertFailsWith<IllegalArgumentException> {
            BatchJobBuilder("job\u0000secret")
        }
    }
