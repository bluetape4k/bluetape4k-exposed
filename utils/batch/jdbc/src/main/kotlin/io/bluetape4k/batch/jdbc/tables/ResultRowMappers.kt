...
fun ResultRow.toStepExecution(
    checkpointJson: io.bluetape4k.batch.internal.CheckpointJson,
): StepExecution = toStepExecution(checkpointJson as CheckpointJson)
