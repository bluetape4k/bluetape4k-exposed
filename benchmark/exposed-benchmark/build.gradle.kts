...
dependencies {
    ...
    add("benchmarkImplementation", libs.bluetape4k.core)
    add("benchmarkImplementation", libs.bluetape4k.coroutines)
    add("benchmarkImplementation", libs.bluetape4k.idgenerators)
    add("benchmarkImplementation", libs.bluetape4k.jackson3)
    add("benchmarkImplementation", libs.bluetape4k.logging)
    add("benchmarkImplementation", libs.bluetape4k.testcontainers)
    add("benchmarkImplementation", libs.bluetape4k.virtualthread.api)
    ...
    add("benchmarkImplementation", libs.exposed.java.time)
    add("benchmarkImplementation", libs.exposed.jdbc)
    add("benchmarkImplementation", libs.exposed.r2dbc)
    add("benchmarkImplementation", libs.h2.v2)
    add("benchmarkImplementation", libs.hikaricp)
    ...
    add("benchmarkImplementation", libs.redisson)
    add("benchmarkImplementation", libs.slf4j.api)
