...
- [ ] **Step 1: RED — 관찰 outcome 계약을 먼저 작성한다**
...
- [ ] **Step 2: GREEN — helper를 bounded, redacted 구현으로 추가한다**
...
- [ ] **Step 1: RED — 반복 가능한 matrix 행과 증적 필드를 정의한다**
...
- [ ] **Step 2: GREEN — 기존 V2 property mapping과 selector를 사용해 실행한다**
...
- [ ] **Step 1: RED — consumer 종료와 실패 조합을 잠근다**
...
- [ ] **Step 2: GREEN — 기존 lifecycle contract를 최소 변경으로 고정한다**
...
- [ ] **Step 1: RED — 두 borrower 사이 state leak probe를 추가한다**
...
- [ ] **Step 2: GREEN 또는 N/A — 최소 격리만 적용한다**
...
- [ ] **Step 2: README를 양 locale로 동일 계약에 맞춘다**
...
- [ ] **Step 1: targeted compile/test and static checks**
