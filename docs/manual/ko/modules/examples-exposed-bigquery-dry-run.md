...
[![BigQuery dry-run example 흐름](../../assets/readme-diagrams/examples-exposed-bigquery-dry-run-flow-01.png)](../../assets/readme-diagrams/examples-exposed-bigquery-dry-run-flow-01.svg)
