...
Maven 좌표: `io.github.bluetape4k.exposed:bluetape4k-exposed-clickhouse`. API 중심의 빠른 시작: 안정판에서 확인한 가장 작은 예제부터 실행한 뒤 작업별 사용법으로 넓혀 가세요.
...
Maven 좌표: `io.github.bluetape4k.exposed:bluetape4k-exposed-clickhouse`
...
[Gradle 빌드 파일](../../../../exposed/clickhouse/build.gradle.kts)
