...
title: "Exposed Timefold Solver Persistence"
locale: "en"
kind: "library"
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-timefold-solver-persistence`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-timefold-solver-persistence`
...
[Gradle build file](../../../../exposed/timefold-solver-persistence/build.gradle.kts)
