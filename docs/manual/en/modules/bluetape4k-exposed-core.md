...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-core`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-core`
...
[Gradle build file](../../../../exposed/core/build.gradle.kts)
