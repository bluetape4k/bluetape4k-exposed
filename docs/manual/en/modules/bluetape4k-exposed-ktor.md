...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-ktor`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-ktor`
...
[Gradle build file](../../../../ktor/exposed/build.gradle.kts)
