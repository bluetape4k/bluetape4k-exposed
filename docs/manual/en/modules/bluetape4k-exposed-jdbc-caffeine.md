...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-jdbc-caffeine`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-jdbc-caffeine`
...
[Gradle build file](../../../../exposed/jdbc-caffeine/build.gradle.kts)
