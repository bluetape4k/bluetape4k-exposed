...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-r2dbc-caffeine`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-r2dbc-caffeine`
...
[Gradle build file](../../../../exposed/r2dbc-caffeine/build.gradle.kts)
