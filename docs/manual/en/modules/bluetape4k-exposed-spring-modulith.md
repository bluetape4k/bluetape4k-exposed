...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-spring-modulith`. API-oriented quick start: begin with the smallest stable-release API example, then expand it by task.
...
Maven coordinate: `io.github.bluetape4k.exposed:bluetape4k-exposed-spring-modulith`
...
[Gradle build file](../../../../spring-boot/spring-modulith/build.gradle.kts)
