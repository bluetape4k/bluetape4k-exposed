...
![findById — diagram](../../docs/images/readme-diagrams/exposed-jdbc-sequence-02.png)

### save + findPage — 저장 후 페이징 조회

![save + findPage — diagram](../../docs/images/readme-diagrams/exposed-jdbc-sequence-03.png)

### softDeleteById / restoreById — 논리 삭제 및 복원

![softDeleteById / restoreById — diagram](../../docs/images/readme-diagrams/exposed-jdbc-sequence-04.png)
